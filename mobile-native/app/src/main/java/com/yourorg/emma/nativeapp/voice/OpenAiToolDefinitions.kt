...
object OpenAiToolDefinitions {
    val definitions: JSONArray by lazy { JSONArray(TOOL_DEFINITIONS_JSON) }

    private const val TOOL_DEFINITIONS_JSON = """
        [
          {
            "type": "function",
            "name": "get_people",
          ...
          },
          {
            ...
            "parameters": {
              ...
              "properties": {
                "memoryId": {
                  "type": "string",
                  "description": "Identifier of the memory receiving new media."
                },
                "media": {
                  "type": "array",
