...
const TOOL_DEFINITIONS = [
  ...
  },
  {
    type: 'function',
    name: 'get_memories',
    description: 'Find memories connected to a person, timeframe, or keyword.',
    parameters: {
      type: 'object',
      properties: {
        query: {
          type: 'string',
          description: 'Keywords to search for in the memory content.'
        },
        personId: {
          type: 'string',
  ...
  },
  {
    type: 'function',
    name: 'delete_memory',
    description: 'Permanently remove a memory capsule from the vault.',
    parameters: {
      type: 'object',
      properties: {
        memoryId: {
  ...
  },
  {
    type: 'function',
    name: 'delete_person',
    description: 'Permanently remove a person from the vault.',
    parameters: {
      type: 'object',
      properties: {
        personId: {
